...
sa_listen_cfg_path = get_resource_path(
    "resource/level0/case20_timer003/listen_test.cfg",
    isdir=None)
sa_listen_json_path = get_resource_path(
    "resource/level0/case20_timer003/listen_test.json",
    isdir=None)
...
sa_para_path = get_resource_path(
    "resource/level0/case20_timer003/samgr.para",
    isdir=None)
sa_para_dac_path = get_resource_path(
    "resource/level0/case20_timer003/samgr.para.dac",
    isdir=None)
