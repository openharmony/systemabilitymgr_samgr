...
sa_listen_cfg_path = get_resource_path(
    "resource/level0/case06_commonevent001/listen_test.cfg",
    isdir=None)
sa_listen_json_path = get_resource_path(
    "resource/level0/case06_commonevent001/listen_test.json",
    isdir=None)
...
class case06_commonevent001(TestCase):
    ...
    def test_step(self):
        ...
        CheckPoint("find SA DistributedDeviceProfile")
        assert "DistributedDeviceProfile" in result
    ...
    def teardown(self):
        ...
        self.log.info("case06_commonevent001 down")
