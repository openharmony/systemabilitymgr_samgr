...
sa_listen_cfg_path = get_resource_path(
    "resource/level0/case11_delay_time003/listen_test.cfg",
    isdir=None)
sa_listen_json_path = get_resource_path(
    "resource/level0/case11_delay_time003/listen_test.json",
    isdir=None)
...
class case11_delay_time003(TestCase):
    ...
    def test_step(self):
        ...
        driver.Screen.close()
        CheckPoint("The unload setting time exceeds the limit. By default, 1494 and 1499 will be unloaded after 5 minutes")
        time.sleep(300)
        result = driver.System.execute_command("hidumper -ls")
        max_wait_time = 60
        wait_time = 0
