...
class case16_dysaprofile001(TestCase):
    ...
    def setup(self):
        self.log.info("case16_dysaprofile001 start")
        need_source = {"cfg": True, "fwk": False, "listen_test": True, "audio_ability": False, "ondemand": True,
                       "proxy": True, "para": False}
        self.source_path = get_source_path(need_source=need_source, casename="level0/case16_dysaprofile001")
    ...
    def test_step(self):
        ...
        assert "deviceonline value:on" in result

    def teardown(self):
        remove_source(source_path=self.source_path, driver=self.driver, sn=self.sn)
        self.log.info("case16_dysaprofile001 down")
