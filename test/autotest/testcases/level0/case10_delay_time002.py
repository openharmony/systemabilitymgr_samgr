...
sa_listen_cfg_path = get_resource_path(
    "resource/level0/case10_delay_time002/listen_test.cfg",
    isdir=None)
sa_listen_json_path = get_resource_path(
    "resource/level0/case10_delay_time002/listen_test.json",
    isdir=None)
...
class case10_delay_time002(TestCase):
    ...
    def test_step(self):
        ...
        maxWaitTime = 5
        waitTime = 0
        while (("1494" not in result or "1499" not in result) and waitTime <= maxWaitTime):
            waitTime += 1
            time.sleep(1)
            result = driver.System.execute_command("hidumper -ls")
        ...
        driver.Screen.close()
        CheckPoint("The unload time is -1, and 1494 and 1499 are unloaded immediately by default")
        result = driver.System.execute_command("hidumper -ls")
        maxWaitTime = 10
        waitTime = 0
        while (("1494" in result or "1499" in result) and waitTime <= maxWaitTime):
            waitTime += 1
            time.sleep(1)
            result = driver.System.execute_command("hidumper -ls")
    ...
    def teardown(self):
        ...
        self.log.info("case10_delay_time002 down")
