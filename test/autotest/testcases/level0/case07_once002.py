...
sa_listen_cfg_path = get_resource_path(
    "resource/level0/case07_once002/listen_test.cfg",
    isdir=None)
sa_listen_json_path = get_resource_path(
    "resource/level0/case07_once002/listen_test.json",
    isdir=None)
...
class case07_once002(TestCase):
    ...
    def teardown(self):
        ...
        self.log.info("case07_once002 down")
