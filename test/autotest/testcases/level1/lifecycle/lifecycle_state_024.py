...
sa_listen_cfg_path = get_resource_path(
    "resource/level/lifecycle_state_024/listen_test.cfg",
    isdir=None)

sa_listen_json_path = get_resource_path(
    "resource/level/lifecycle_state_024/listen_test.json",
    isdir=None)
...
class LifeCycle_State_024(TestCase):
    ...
    def test_step(self):
        ...
        result = driver.System.execute_command("ondemand test 24")
