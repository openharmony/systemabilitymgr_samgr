...
sa_listen_cfg_path = get_resource_path(
    "resource/level/lifecycle_state_005/listen_test.cfg",
    isdir=None)
sa_listen_json_path = get_resource_path(
    "resource/level/lifecycle_state_005/listen_test.json",
    isdir=None)
...
class LifeCycle_State_005(TestCase):
    ...
    def test_step(self):
        ...
        device_logger.start_log(get_report_dir() + 'lifecycle_state_005_txt')
        result = driver.System.execute_command("ondemand test 5")
