    ...
    const sptr<IRemoteObject>& remoteObject)
{
    ...
    auto notifyAddedTask = [systemAbilityId, remoteObject, weakThis = weak_from_this()]() {
        ...
        LHILOGD("SendSaAddedMsg notify SA:%{public}d", systemAbilityId);
    ...
    const std::string& srcDeviceId, const sptr<ISystemAbilityLoadCallback>& callback)
{
    ...
    auto delayTask = [systemAbilityId, name, srcDeviceId, callback, weakThis = weak_from_this()]() {
        ...
        LHILOGD("SendCheckLoadedMsg handle for SA:%{public}d", systemAbilityId);
    ...
    const sptr<ISystemAbilityLoadCallback>& callback)
{
    ...
    auto notifyLoadedTask = [systemAbilityId, remoteObject, callback, weakThis = weak_from_this()]() {
        ...
        LHILOGD("SendLoadedSaMsg notify SA:%{public}d", systemAbilityId);
